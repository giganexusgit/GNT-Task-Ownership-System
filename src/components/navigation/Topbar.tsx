  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 sm:gap-3">
        ...
        {/* Quick Account Switcher (For Evaluation & QA) */}
        <div className="relative" ref={roleMenuRef}>
          <button
            id="btn-switch-account-menu"
            onClick={() => setShowRoleMenu(!showRoleMenu)}
            className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-xs font-semibold text-slate-700 shadow-2xs transition-colors"
          >
